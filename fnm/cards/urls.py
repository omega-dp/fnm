...
urlpatterns = [
    ...
    path('<int:pk>/assign/', AssignJobCardApi.as_view(), name='assign_job_card'),
    path('<int:pk>/complete/', CompleteJobCardApi.as_view(), name='complete_job_card'),
    path('<int:pk>/close/', CloseJobCardApi.as_view(), name='close_job_card'),
]
